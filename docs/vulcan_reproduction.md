...
| `scripts/prune_fire_plans.py` | Keeps one active standard FireWorld plan per scene/template/intensity and recoverably archives superseded plans/timelines; inspect the default dry run before passing `--apply`. |
